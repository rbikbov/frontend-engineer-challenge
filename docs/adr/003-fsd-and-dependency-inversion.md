...
- **Паттерн deps**: Компоненты уровня Entities принимают функции рендеринга или обработчики событий как опциональные зависимости. Реальная логика «внедряется» в них на уровне Widgets.
...
- Высокая предсказуемость кода: всегда понятно, где искать логику.
