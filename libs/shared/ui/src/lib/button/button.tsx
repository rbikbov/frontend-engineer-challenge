...
const buttonVariants = cva(
  ...
  'focus-visible:ring-brand inline-flex items-center justify-center border border-transparent text-sm leading-none font-medium whitespace-nowrap transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:cursor-not-allowed',
  {
    variants: {
