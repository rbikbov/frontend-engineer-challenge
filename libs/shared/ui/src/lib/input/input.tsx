  ...
  (
    ...
    return (
      <div className="flex w-full flex-col gap-2">
        ...
        >
          ...
          >
            {label && (
              <Label.Root
                htmlFor={inputId}
                className="text-foreground-secondary block cursor-default text-[12px] leading-none"
              >
                {label}
              </Label.Root>
            )}
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            <Comp
              ...
              type={type}
              disabled={disabled}
              className="placeholder:text-foreground-secondary/50 h-6 w-full flex-1 bg-transparent p-0 text-[15px] leading-[24px] outline-none placeholder:opacity-100"
              ref={ref}
              onFocus={handleFocus}
              onBlur={handleBlur}
        ...
        {error && (
          <p className="text-invalid text-[12px] leading-none transition-all">
            {error}
          </p>
        )}
      </div>
